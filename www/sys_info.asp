...
function myonload()
{
	var gets=new Array;
	gets = getArgs();
	if( gets["refreshtop"] == 1 )
	{
		parent.window.refreshTop();
	}
	var model = parseInt(document.getElementById("dev_model_str").value);
	var obj_model = document.getElementById("dev_model");
	switch(model)
	{
		case 0:
			obj_model.value = "标清编码";
			break;
		case 1:
			obj_model.value = "高清编码";
			break;
		case 2:
			obj_model.value = "视频解码";
			break;
        case 3:
			obj_model.value = "解码&转码";
            break;
		default:
			obj_model.value = model;
			break;
	}
...
<table width="1080">
  ...
  <tr><td>
	...
	<input type="hidden" id="pathname" name="pathname" value="sys_info.asp">
	<input type="hidden" id="dev_model_str" name="dev_model_str" value="<%asp_get_dev_model();%>">
	<tr>
	  <td class="lable">设备名称</td>
      <td>
        <input type="text" id="dev_name" name="dev_name"  value=<%asp_get_dev_hostname();%> size="32" />
      </td>
    </tr>
    ...
    <tr>	
      ...
      <td>
        <input type="text" id="dev_mac"  name="dev_mac" disabled="disabled" readonly="readonly" onblur="MACtobig()" value="<%asp_get_dev_mac();%>" size="32" />
      </td>
    </tr>
	...
	<tr>
      ...
      <td>
        <input type="text" id="dev_sn" name="dev_sn" disabled="disabled" readonly="readonly" value="<%asp_get_dev_sn();%>" size="32" />
      </td>
    </tr>
    <tr>
      <td class="lable">设备型号</td>
      <td>
        <input type="text" id="dev_model" name="dev_model" disabled="disabled" readonly="readonly" value="" size="32" />
      </td>
    </tr>
    <tr>
      <td class="lable">主控版本</td>
      <td>
        <input type="text" id="dev_ver" name="dev_ver" disabled="disabled" readonly="readonly" value="<%asp_get_dev_ver();%>" size="32" />
      </td>
    </tr>
	</tr>
	<tr>
      ...
      <td>
        <input type="text" id="dev_updatetime" name="dev_updatetime" disabled="disabled" readonly="readonly" value="<%asp_get_dev_buildtime();%>" size="32" />
      </td>
    </tr>
    <tr>
      <td >
        <input type="submit" name="sysinfo_submit" 
		style="border:none;background:url(images/save_btn.png);width:83;height:20;cursor:hand;" 
	  ...
	  <td >
		...
		style="display:none;border:none;background:url(images/reboot_btn.png);width:83;height:20;cursor:hand;" 
